...
// This file is retained only for frozen V1 board/history tests. The live
// dispatcher is in board.go and never calls these readers after the V2
// cutover; migration itself owns the production V1 input path.
...
// project root. It is exercised by the retained V1 compatibility tests only.
