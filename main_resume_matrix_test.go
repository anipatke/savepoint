...
func resumeMatrixCases() []matrixCase {
	return []matrixCase{
		...
		},
		{
			...
			wantAction: "Owner: request an optional Task Check or record an explicit owner waiver; the Full Objective Check remains mandatory before Objective closure.",
		},
		{
		...
		},
		{
			...
			wantSelectionDiagnostic: data.SelectionDone,
		},
		{
