...
4. **Quality Review section** — semantic-review findings against the project's code style rules (advisory only).
...
4. **Stop after proposals.** Do not update the router, do not mark the epic audited, and do not commit.
5. **Be honest about deviations.** If the implementation diverged from the design, document why in the epic-Design.md section.
