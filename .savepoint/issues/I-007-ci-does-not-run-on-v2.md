...
history:
    - at: "2026-09-22T09:01:43Z"
      actor:
          ...
          session: owner-request-2026-09-22
      kind: owner_decision
      note: Owner accepted I-007 as resolved after v2 was added to both branch filters and make ci passed.
---
## Migrated from V1

Relocated verbatim from the V1 defect body at `.savepoint/releases/v2/defects/D008-ci-does-not-run-on-v2.md` (release `v2`).
