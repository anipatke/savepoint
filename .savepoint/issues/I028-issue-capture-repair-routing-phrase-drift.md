...
history:
  ...
  - at: '2026-09-22T00:00:04Z'
    actor: {role: owner, session: user}
    kind: owner_decision
    note: Owner accepted I028 as resolved based on the recorded repair and passing test evidence.
---

# I028: Shared issue-capture reference drifted from its own doc-consistency test
...
- `git stash` on the `v2` branch at `9ece207` reproduced the same two
  ...
  is independent of the I019 repair.
