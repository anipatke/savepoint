...
resolution:
  ...
  reason: >-
    Owner waived an independent Check and accepted I-014 as resolved based on
...
history:
  ...
  - at: '2026-09-22T09:18:44Z'
    ...
    kind: owner_decision
    note: >-
      Owner waived independent verification and accepted I-014 as resolved based
      on the repair evidence from the implementing task.
---

# I-014: Done column and task card focus accent should be green not orange
