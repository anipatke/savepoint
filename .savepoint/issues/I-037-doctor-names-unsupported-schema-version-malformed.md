...
resolution:
  ...
  check: C-934
  actor: {role: checker, session: i037-check-20260926}
  at: '2026-09-25T21:30:30Z'
  reason: >-
    Independent Quick re-check proved unsupported integer and malformed
    schema-version diagnostics and their distinct repairs.
history:
  - at: '2026-09-23T11:00:00Z'
    actor: {role: executor, session: t022-build-20260923}
    kind: observed
  ...
  - at: '2026-09-25T21:30:30Z'
    ...
    check: C-934
    note: >-
      CLEAR. The regression test and an independent boundary probe proved
      unsupported integer values use schema-version-unsupported and malformed
      values retain schema-version-malformed, with the matching repair text.
---
