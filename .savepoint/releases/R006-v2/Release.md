...
|---|---|---|
| E41 / O001 — Migration source fixtures | Representative V1 work and history have frozen, interpretable preservation evidence. | None |
| E42 / O002 — Project schema and identity | V2 projects load with stable IDs, strict diagnostics, and preserved author content. | E41 |
| E43 / O003 — Task and Check gates | Completion and dependency decisions reflect technical clearance and conditional acceptance. | E42 |
| E44 / O004 — Issues and integration | Follow-up converges through one Issue model and Objective Checks. | E43 |
| E45 / O005 — Safe migration | Active V1 work converts predictably with archives, references, and recovery. | E44 |
| E46 / O006 — Agent workflow | Four public skills deliver bounded planning, execution, and independent verification. | E44 |
