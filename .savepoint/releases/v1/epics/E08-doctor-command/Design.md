...
- Integrity checks for config, router state, release/epic/task structure, YAML/frontmatter, dependency references, cycles, duplicate task IDs, audit state, and orphaned tasks.
