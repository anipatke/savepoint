...
Objective sidebar/selection; three columns with badges; prominent Next; Issues/Defect filtering; Check/history details; gate-aware actions; V2 watchers and plain output.
...
Replace release/epic-specific model and duplicate overlays with V2 presentation; I/O stays in explicit commands and gates in data.
...
Narrow/short terminals, Unicode width, stable borders/focus, no accidental wrapping, color fallbacks, no-TTY output, edits/reloads/conflicts, and blocked actions verified.
