...
| # | Epic | Status | Tasks |
|---|------|--------|-------|
| 35 | Split Task and Epic Audits | Planned | 0/4 done |
| 36 | Visual-identity template polish | Planned | 0/2 done |
| 37 | Guardrails.md template | Planned | 0/1 done |
| 38 | Health-Check.md template | Planned | 0/1 done |
| 39 | Code-style ownership and policy-asset upgrade | Planned | 0/2 done |

## Build order

Epic numbering does not imply build order. Build in this sequence:

1. **E36** — implementation already exists in the working tree; verify against ACs, record context logs, and commit before other epics touch `templates/project/.savepoint/Design.md`.
...
4. **E39** — depends on E37 for the STYLE rules existing and on E35 for the final audit skeleton and build-task contracts, so it builds last.
