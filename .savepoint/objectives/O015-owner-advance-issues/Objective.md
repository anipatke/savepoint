...
# O015: Let the owner advance Issues from the board
...
as I001 can also describe behavior that the current implementation already
...
- I001 remains the motivating stale-record example and records the owner's
  accepted closure under the schema available before this Objective. O015
  adds the honest superseded path for future stale reports without rewriting
  I001's recorded owner decision.
...
- Regression coverage using I001's stale-report scenario, without rewriting
