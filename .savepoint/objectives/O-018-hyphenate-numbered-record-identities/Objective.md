...
release: R-006
exception:
    requirements: [C-910 NEEDS WORK, I-033, I-034]
    reason: >-
        Owner accepted the repairs recorded for I-033 (bare X### placeholders in AGENTS.md and Design.md hyphenated) and I-034 (self-comparing examples reworded) without requiring a fresh-session recheck. This is owner-accepted completion by exception, not a new CLEAR result. C-910's NEEDS WORK verdict stands unchanged as the record of what was found. R-006's mandatory Release Check is unaffected and must still run and pass separately.
    owner: ani
    recorded_at: '2026-09-23T09:05:00Z'
    check: C-910
---

# O-018: Hyphenate every numbered V2 record identity
...
I-022: bare numbered identities, with the digits run straight onto the kind
letter, are harder to scan than `O-015` and `T-012`. The owner asked for the hyphenated form on every
...
identity references rewritten in place; no other Check content changes. T-019
and T-020 land in one commit because the repository does not load between them.
